...
public class DiamondBookshelfBlock extends IronbookshelvesModElements.ModElement {
    @ObjectHolder("ironbookshelves:diamond_bookshelf")
    public static final Block block = null;

    public DiamondBookshelfBlock(IronbookshelvesModElements instance) {
        super(instance, 3);
    }
