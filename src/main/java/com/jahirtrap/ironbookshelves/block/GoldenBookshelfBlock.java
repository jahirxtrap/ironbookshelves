...
public class GoldenBookshelfBlock extends IronbookshelvesModElements.ModElement {
    @ObjectHolder("ironbookshelves:golden_bookshelf")
    public static final Block block = null;

    public GoldenBookshelfBlock(IronbookshelvesModElements instance) {
        super(instance, 2);
    }
    ...
    public static class CustomBlock extends Block {
        public CustomBlock() {
            super(Block.Properties.of(Material.METAL).sound(SoundType.METAL).strength(3f, 6f).lightLevel(s -> 0).harvestLevel(2)
