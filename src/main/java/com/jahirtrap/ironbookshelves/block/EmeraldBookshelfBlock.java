...
public class EmeraldBookshelfBlock extends IronbookshelvesModElements.ModElement {
    @ObjectHolder("ironbookshelves:emerald_bookshelf")
    public static final Block block = null;

    public EmeraldBookshelfBlock(IronbookshelvesModElements instance) {
        super(instance, 4);
    }
